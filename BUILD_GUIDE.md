...
### المشكلة:
❌ **electron-builder يفشل** عند محاولة بناء v0.1.8
...
إذا أردت بناء v0.1.8 بالفعل، يجب حل المشاكل التالية:
...
## التحديثات المنفّذة (v0.1.8 concepts)
...
**الإصدار الحالي على الويب**: 0.1.8
