import { convertNumbersToEnglish, formatArabicGregorianDateTimeWithDay } from "./utils";
const formatDateWithDay = (d: any) => formatArabicGregorianDateTimeWithDay(new Date(d))
