...
console.log('--- Mobile Build Wrapper (Surgical Mode) ---');
...
try {
    ...
    console.log('\nStarting next build (Static Export for Mobile)...');
    ...
    const result = spawnSync(cmd, ['next', 'build'], {
        ...
        env: {
            ...process.env,
            IS_ELECTRON: 'true', // We use this flag to trigger export in next.config.js
